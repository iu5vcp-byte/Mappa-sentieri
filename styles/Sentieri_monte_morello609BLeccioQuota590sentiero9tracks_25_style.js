...
var style_Sentieri_monte_morello609BLeccioQuota590sentiero9tracks_25 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var repeat = 180.0;
    var placement = 'line';
    if (exp_label_Sentieri_monte_morello609BLeccioQuota590sentiero9tracks_25_eval_expression(context) !== null && resolution > 0 && resolution < 0) {
        labelText = String(exp_label_Sentieri_monte_morello609BLeccioQuota590sentiero9tracks_25_eval_expression(context));
    }
