...
var style_Sentieri_monte_morello610MorelloPoggioallAiatracks_26 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var repeat = 180.0;
    var placement = 'line';
    if (exp_label_Sentieri_monte_morello610MorelloPoggioallAiatracks_26_eval_expression(context) !== null && resolution > 0 && resolution < 0) {
        labelText = String(exp_label_Sentieri_monte_morello610MorelloPoggioallAiatracks_26_eval_expression(context));
    }
